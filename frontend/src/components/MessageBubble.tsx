...
export default function MessageBubble({
    ...
    return (
        ...
        >
            <div
                className={`w-[80%] bg-[#1e1e1e] text-[#f3f4f6] py-6 px-6 min-h-[150px] rounded-[2rem] shadow-[0_10px_25px_rgba(0,0,0,0.4)] transition-all duration-300 hover:scale-[1.02] relative pb-[48px] ${isMine ? 'rounded-tr-none' : 'rounded-tl-none'
                    }`}
            >
                {!isMine && (
                    <img
